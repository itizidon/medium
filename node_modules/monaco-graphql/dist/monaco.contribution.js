...
define(["require", "exports", "./api", "monaco-editor/esm/vs/editor/editor.api"], function (require, exports, api_1, monaco) {
    ...
    monaco.languages.onLanguage(exports.LANGUAGE_ID, function () { return __awaiter(void 0, void 0, void 0, function () {
        var graphqlMode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, getMode()];
                case 1:
                    graphqlMode = _a.sent();
    ...
    function getMode() {
        return new Promise(function (resolve_1, reject_1) { require(['./graphqlMode'], resolve_1, reject_1); }).then(__importStar);
    }
});
