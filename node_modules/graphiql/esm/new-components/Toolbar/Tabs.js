...
var Tabs = function (_a) {
    var tabs = _a.tabs, active = _a.active, onChange = _a.onChange;
    return (jsx(WithDividers, null, tabs.map(function (tab, index) { return (jsx(Tab, { key: index, active: active === index, onClick: function () { return onChange === null || onChange === void 0 ? void 0 : onChange(index); } }, tab)); })));
};
export default Tabs;
